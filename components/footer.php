<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:nastra@gmail.com"><i class="fas fa-envelope"></i> nastra@web.in</a>
         <a href="https://www.google.com/pondichery"><i class="fas fa-map-marker-alt"></i> Pondichery </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Soul</span> | all rights reserved!</div>
