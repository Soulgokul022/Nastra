...
<div class="box">
   ...
   <div class="flex-btn">
      <a href="upd_add.php?update=<?= $fetch_products['id']; ?>" class="option-btn">update</a>
      <a href="add.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
   </div>
</div>
<?php
      }
